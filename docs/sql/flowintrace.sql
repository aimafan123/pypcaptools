...
--
-- Table structure for table `http_flow`
--
...
CREATE TABLE `http_flow` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `source_ip` (`source_ip`,`destination_ip`,`source_port`,`destination_port`,`protocol`,`capture_time`),
  KEY `trace_id` (`trace_id`),
  CONSTRAINT `http_flow_ibfk_1` FOREIGN KEY (`trace_id`) REFERENCES `http_trace` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2024-12-24 20:41:47
